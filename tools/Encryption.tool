...
$text = $_POST['code'];
?>
<title>encode & decode by Syntax_Notfound </title>
<STYLE>
...
<center>
<div class="jaya">Hiidenymouz Tools</div>
<form method="post"><br>
...
echo "<from><center><h3>HASIL</h3></center><textarea cols=80 rows=10 class='inputz' readonly>".$html."</textarea><BR/><BR/><h2>Decode By Syntax_Notfound</h2></center></from>";
?>