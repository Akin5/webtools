...
<div class="menu">
<marquee behavior="alternate"><font color="white" size="30px" face="Metal Mania">××××××××××××LOKOMEDIA EXPLOITER×××××××××××</font></marquee><br>
</head>
<center>
<?php cover(); ?>
<form method="post">
...
<br>
<a href="index.html"><FONT color="white"><--- BACK TO MENU</font></a></div><br></B></div>
<font face="sans-serif" size="3" color="white">Copyright © 2019 - codexrush</font>
</center>
<?php
function ngcurl($url) {
    $curl = curl_init($url);
